...
# ----------------------------------------------
	...
	d = open('5678.json', 'r', encoding = 'utf-8')
	data = json.load(d)
	d.close()
...
# ----------------------------------------------
	...
	with open("udemy-new.csv", 'a', encoding = 'utf-8') as f:
...
# ----------------------------------------------
			...
			link = 'https://www.udemy.com/api-2.0/courses/' + str(iden) +'?fields[course]=description,num_subscribers,image_480x270'
